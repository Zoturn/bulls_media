...
## Purpose
Gives a human operator the inbox, case detail, live run trace and approval gate needed to review
what the agent proposes for an inbound advertising enquiry and to record a decision before
anything the agent drafted counts as sent.
## Requirements
